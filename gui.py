...
Description:
This is the main script for the second project aim, focusing on creating a GUI for end users to create their own GAN models in.

Usage:
Run the script using `python gui.py` in a terminal.
...
train_model.py          - Trains the generated GAN model with the parameters from the ini file.
generate_frames.py      - Generates frames from the end users trained GAN model, returning them to the GUI to display.
"""
...
class App(tk.CTk): # App inherits from custom tkinter library
    ...
    def createLeftSidebar(self):
        ...
        self.buttonFrameGIF = tk.CTkButton(master=self.leftSidebarFrame, text="Save as GIF", command=self.frame_GIF) # Download frames as GIF
        ...
        self.gifFPS = tk.CTkEntry(self.leftSidebarFrame, placeholder_text="int e.g. 60") # FPS for GIF download, default 60fps
    ...
    def createRightSidebar(self):
        ...
        self.buttonResetGANVars = tk.CTkButton(master=self.rightSidebarFrame, text="Restart GAN Creator", command=self.resetGAN, fg_color="red", hover_color="red") #Reset variables for GAN creation
        self.buttonResetGANVars.grid(row=0, column=0, padx=100, pady=(20, 10), sticky="nsew") #Sets position inside of the frame

        self.createTabview()

        self.buttonTraining = tk.CTkButton(master=self, text="Begin Training", command=self.beginTraining) #Load training loop and saving parameters
        self.buttonTraining.grid(row=1, column=5, padx=20, pady=(20, 10))
    ...
    def createTabview(self):
        # Tabs for different sections of the GAN training process
    ...
    def load_generator(self):
        ...
        self.textConsoleLog.insert("end", f"\nSelected generator {generator_model_file_path} which uses the class {generator_class_file_path}.", )
